...
public class NauczycielPredicate {

    // входящие данные для построения предиката
    private SearchCriteria criteria;

    public NauczycielPredicate(SearchCriteria criteria) {
    ...
    public BooleanExpression getPredicate() throws JsonProcessingException {
        ...
        PathBuilder<Nauczyciel> entityPath =
                new PathBuilder<>(Nauczyciel.class, "product");
        ...
        if (StringUtils.isNumeric(criteria.getValue().toString())) {
            ...
            entityPath =
                    new PathBuilder<>(Nauczyciel.class, criteria.getKey() + ".id");
