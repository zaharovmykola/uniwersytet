...
public class StudentPredicate {
    ...
    public StudentPredicate(SearchCriteria criteria) {
    ...
    public BooleanExpression getPredicate() throws JsonProcessingException {
        ...
        PathBuilder<Student> entityPath =
                new PathBuilder<>(Student.class, "product");
        ...
        if (StringUtils.isNumeric(criteria.getValue().toString())) {
            ...
            entityPath =
                    new PathBuilder<>(Student.class, criteria.getKey() + ".id");
